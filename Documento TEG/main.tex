...
\lfoot[]{}
\cfoot[]{}
\rfoot[]{Herramienta de análisis de datos para administración y optimización de recursos en hogares usando Internet de las Cosas}
...
\fancyfoot[L]{}
\fancyfoot[C]{}
\fancyfoot[R]{Herramienta de análisis de datos para administración y optimización de recursos en hogares usando Internet de las Cosas}
\renewcommand{\headrulewidth}{0.5pt}
\renewcommand{\footrulewidth}{0.5pt}
}
